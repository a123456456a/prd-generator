...
```
┌───────────────────────────────────────────────────────────────────┐
│ AppHeader:  PRD Generator        [⚙ 模型设置]  [中/EN]  用户名 ▾   │
├───────────────────────────────────────────────────────────────────┤
│ 模型提供商设置                                     [+ 新增提供商]  │
│                                                                     │
│ ┌─────────────────────────────────────────────────────────────┐   │
│ │ ● 默认  DeepSeek        标签: 工作 DeepSeek                  │   │
│ │   baseURL: https://api.deepseek.com   默认模型: deepseek-chat│   │
│ │   Key: sk-ab********wxyz     最近测试: ✅ 成功 09-03 07:50   │   │
│ │   [设为默认] [编辑] [测试连接] [停用] [删除]                  │   │
│ ├─────────────────────────────────────────────────────────────┤   │
│ │   智谱 GLM      标签: 个人 GLM                                │   │
│ │   baseURL: https://open.bigmodel.cn/api/paas/v4/             │   │
│ │   Key: 4f9c****************  默认模型: glm-4.6  [已停用]      │   │
│ │   [设为默认] [编辑] [测试连接] [启用] [删除]                  │   │
│ └─────────────────────────────────────────────────────────────┘   │
│                                                                     │
│ 空状态（无任何配置时）：                                            │
│ 「还没有配置任何模型提供商，将使用系统默认模型。」                  │
│ [+ 添加你的第一个模型提供商]                                        │
└───────────────────────────────────────────────────────────────────┘
...
│         ( Claude )( 自定义 )  │
│                                │
│ 备注名称: [__________________]│
│ Base URL: https://api.deepseek.com   （只读，展开"高级"可改）│
│ API Key:  [•••••••••••••••••] （编辑态留空=不修改，显示原掩码）│
│ 默认模型: [deepseek-chat ▾]  （可手填自定义模型名）           │
│                                │
│ [测试连接]  状态: 未测试/✅/❌ │
│                                │
│              [取消]  [保存]   │
...
工作台（`WorkbenchView.vue`）生成选项区新增一行只读摘要，例如：「当前使用：DeepSeek · deepseek-chat（默认） · [去设置模型 →]」；未配置时显示「当前使用：系统默认模型 · [去添加我的模型 →]」。
